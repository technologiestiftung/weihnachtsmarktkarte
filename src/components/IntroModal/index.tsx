      ...
      >
        ...
        <div className="fixed inset-0">
          <div className="flex min-h-full items-center justify-center p-4 leading-7">
            <Dialog.Panel className="overflow-y-auto border-2 border-gold/50  bg-darkblue/80 text-lightblue/90 max-h-full overflow-y-auto p-6 max-w-xs md:max-w-none filter drop-shadow-lg rounded-lg md:min-w-xl md:w-1/2 mx-auto transition-all">
              <button
