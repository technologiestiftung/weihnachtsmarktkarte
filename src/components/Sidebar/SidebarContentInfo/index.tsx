  ...
  return (
    <>
      ...
      <SidebarBody>
        ...
        <Accordion items={[{  id: '1', title: 'Woher kommen die Daten?', content:           
          <>
        ...
        <Accordion items={[{  id: '2', title: 'Was ist Open Data?', content:           
        <>
          <p className="text-sm pb-2">
          ...
          diese, um den Alltag angenehmer zu machen. Deshalb unterstützt die{' '}
                  ...
                  </a>Berliner Behörden bei der Bereit­stellung von Open Data. Mehr offene Daten findet ihr im{' '}
                  <a
                    target="blank"
        ...
        <Accordion items={[{  id: '3', title: 'Wie kann ich mitmachen?', content:
                <>
                <p className="text-sm pb-2">
          ...
          >
            Open Source {' '}
                ...
                und veröffentliche es unter einer freien Lizenz es auf{' '}
          <a
            target="blank"
        ...
        <Accordion items={[{  id: '4', title: 'Was ist mit anderen Städten?', content:
                <>
                <p className="text-sm pb-2">
        ...
        content: 
          ...
          >
            ...
            Du hast Feedback oder willst mehr erfahren? Schaut euch auf unserer Webseite oder kontaktiere uns unter{' '}
          ...
          <Accordion items={[{  id: '2', title: `I don’t speak German: What's this?`, content:           
        <>
          <p className="text-sm pb-2">
