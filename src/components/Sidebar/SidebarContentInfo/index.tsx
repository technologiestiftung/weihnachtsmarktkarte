    ...
    <>
      ...
      <SidebarBody>
        <p className="text-sm pt-2 pb-2">
          ...
          Weihnachtsmärkten ist für jeden Geschmack etwas dabei. Einige der über
          60 Weihnachtsmärkte sind dabei nur für wenige Tage geöffnet. Mit dem
          ...
          kostenlos sind, wo es spannende Attraktionen und Programm zu erleben
          gibt und mehr. Zoom in die Karte rein, um Haltestationen zu
          öffentlichen Verkehrsmitteln und Standorte von nahegelegenen
          öffentlichen Toiletten zu sehen. Mit einem Klick über die
          Teilen-Funktion kannst du den Link zu deinem Lieblingsweihnachtsmarkt
          kopieren und an Freund:innen verschicken.
        </p>
        ...
        <Accordion
          items={[
            {
              id: '4',
              title: 'Was ist mit anderen Städten?',
              content: (
                <>
                  <p className="text-sm pb-2">
              ...
              content: (
                <>
                  <p className="text-sm pb-2">
                    ...
                    <a href="mailto:odis@ts.berlin" className="text-gold">
                      odis@ts.berlin
                    </a>
                    .
        ...
        <Accordion
          items={[
            {
              id: '2',
              title: `I don’t speak German: What's going on here?`,
              content: (
                <>
                  <p className="text-sm pb-2">
                    The Berlin Christmas Market Finder shows all of Berlin’s
                    Christmas markets embedded in an interactive map of the
                    city. You can filter the markets by date and attributes like
                    free entry, themed markets with special attractions or
                    proximity to public transport. Once you have found a
                    Christmas market, you can also share it with your friends
                    and colleagues. Based itself on open data, this application
                    demonstrates the importance and usefulness of opening the
                    data held by Berlin’s public administration. Beyond creating
                    transparency and openness, it allows users to explore the
                    city and come together to spread the Christmas cheer! You
                    can find more open data in the{' '}
                    <a
                      target="blank"
                      href="https://daten.berlin.de"
                      className="text-gold"
