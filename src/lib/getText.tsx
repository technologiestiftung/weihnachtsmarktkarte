  ...
  en: {
    ...
    sidebarInfo: {
      ...
      <a
          ...
          href="https://www.dwd.de/DE/leistungen/opendata/opendata.html"
          class="text-gold"
      >German Weather Service (DWD)</a>, which publishes a variety of meteorological observations and calculations
      ...
      not only creates transparency and openness, but also enables analyses and applications like this one, 
